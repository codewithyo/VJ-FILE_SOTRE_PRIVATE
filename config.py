...
# Bot Information
API_ID = int(environ.get("API_ID", "28583543"))
API_HASH = environ.get("API_HASH", "24fd6e53b6034ccbda0bfd62dfd47ad3")
BOT_TOKEN = environ.get("BOT_TOKEN", "")

PICS = (environ.get('PICS', 'https://graph.org/file/ce1723991756e48c35aa1.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7612404009').split()]
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002606003497"))
